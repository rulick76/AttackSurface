Clone the repository localy to PC that run Docker.
Open the solution in visual studio and select this configuration : Release,Any CPU,Docker and run the project
The browser will be opened with the url defined in the exercise
